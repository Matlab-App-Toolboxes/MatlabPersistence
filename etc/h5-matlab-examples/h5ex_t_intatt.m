...
%
attr = H5A.create (dset, ATTRIBUTE, 'H5T_STD_I64BE', space, 'H5P_DEFAULT');
H5A.write (attr, 'H5T_NATIVE_INT', wdata);
...
% Read the data.
%
rdata=H5A.read (attr, 'H5T_NATIVE_INT');
