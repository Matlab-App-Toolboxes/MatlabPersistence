...
H5P.set_scaleoffset (dcpl, 'H5Z_SO_FLOAT_DSCALE', 2);
H5P.set_chunk (dcpl, fliplr(chunk));

%
% Create the dataset.
%
dset = H5D.create (file, DATASET, 'H5T_IEEE_F64LE', ...
    space, 'H5P_DEFAULT', dcpl,'H5P_DEFAULT');

%
% Write the data to the dataset.
%
H5D.write (dset, 'H5T_NATIVE_DOUBLE', 'H5S_ALL',...
...
%
rdata=...
    H5D.read (dset, 'H5T_NATIVE_DOUBLE', 'H5S_ALL',...
    'H5S_ALL', 'H5P_DEFAULT');
