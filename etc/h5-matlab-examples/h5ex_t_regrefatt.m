...
%
attr = H5A.create (dset, ATTRIBUTE, 'H5T_STD_REF_DSETREG', space, ...
    'H5P_DEFAULT','H5P_DEFAULT');
H5A.write (attr, 'H5T_STD_REF_DSETREG', wdata);
...
attr = H5A.open (dset, ATTRIBUTE, 'H5P_DEFAULT');

%
% Read the data.
%
rdata=H5A.read (attr, 'H5T_STD_REF_DSETREG');
